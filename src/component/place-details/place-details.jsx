...
const PlaceDetails = ({match, places}) => {
  const {
    ...
    description
  } = places.find((item) => item.id === +match.params.id);
          ...
          <div className="property__wrapper">
            ...
            <div className="property__name-wrapper">
              ...
              <button className={isFavorite
                ...
                : `property__bookmark-button property__bookmark-button--active button`} type="button">
...
const PlaceDetailsContainer = connect(mapStateToProps, mapDispatchToProps)(PlaceDetails);

export {PlaceDetails, PlaceDetailsContainer};
